...
const NOISE = [
  ...
  // Reject any known model name followed by a version number (GPT-5, Gemini 3, Llama 4, GPT-5.2, etc.)
  // If it has a number, it's an increment — new families worth adding don't have version numbers yet
  /\b(gpt|gemini|llama|mistral|deepseek|grok|claude|phi|qwen|nemotron|copilot|nova|dall-e|whisper|sora|mixtral|codex)[-\s]?\d/i,
