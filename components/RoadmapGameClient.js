...
const STAGE_POOLS = {
  0: [ // Discovery
    ...
    },
    {
      ...
      choices: [
        { label: "Build exactly what they described",  desc: "The whiteboard is the PRD.",                                        effects: { scope: 2, trust: 1 },    consequence: "You built the whiteboard. The three arrows are now three features. 'Platform strategy' appears in the brief." },
        { label: "Ask users first",                    desc: "Slow down. Ground the vision in something real.",                   effects: { quality: 1, scope: 1 },  consequence: "Slow but grounded. Users confirmed the CEO's instinct and added nuance. This is the job." },
        { label: "Suggest starting smaller",           desc: "Propose a focused version before going broad.",                     effects: { scope: -1, trust: -1 },  consequence: "The CEO did not enjoy this suggestion. You are no longer invited to whiteboard sessions." },
      ],
    },
  ],
  ...
  1: [ // Strategy
    ...
    },
    {
      ...
      choices: [
        { label: "Acknowledge it and cut back",             desc: "Trim the roadmap and quietly pretend it was the plan all along.",         effects: { scope: 1, morale: 1, quality: -1 }, consequence: "Painful but honest. You own the problem. The team respects the reset." },
  ...
  2: [ // Design
    {
      ...
      choices: [
        { label: "Redesign now",                          desc: "Fix it properly while you still can.",                              effects: { scope: -1, morale: 1, quality: 2 }, consequence: "Slower. Better. The designer gives you a subtle nod in standup." },
    ...
    },
    {
      ...
      choices: [
        { label: "Let the designer prototype all three",    desc: "Give them the runway. Get the right answer.",                 effects: { scope: -1, quality: 2 },            consequence: "Time well spent. The decision is right. The designer owns it completely." },
    ...
    },
    {
      ...
      choices: [
        { label: "Allow the full rebuild",                effects: { scope: -2, tech: 2, quality: 1 },   desc: "Declare design bankruptcy and start over.",                                consequence: "Expensive. The right call. In six months the team will forget there was ever a choice." },
        { label: "Decline, patch the existing library",  effects: { scope: 1, tech: -1, morale: -1 },   desc: "'We'll improve it incrementally.'",                                        consequence: "You bought time. The patches accumulate. The designer starts updating their portfolio." },
        { label: "Refactor only the critical components", effects: { scope: -1, tech: 1, morale: 1 },   desc: "Fix the parts that hurt the most.",                                        consequence: "Pragmatic. Not exciting. The team accepts it and moves." },
        { label: "Bring in a contractor to assess",       effects: { tech: 1, trust: 1, scope: -1 },    desc: "Ask an outsider to tell everyone what they already know.",                  consequence: "Outside perspective. The assessment says rebuild. You now have the permission structure to do it." },
      ],
    },
  ],
  ...
  3: [ // Development
    {
      ...
      choices: [
        { label: "Bring in contractors",       desc: "Add more people and hope it somehow speeds things up.",              effects: { scope: 2, morale: -1, tech: -1 },   consequence: "Timeline recovers. The team has friction with the new people. The new people will outlast the friction." },
        ...
        { label: "Push the team to crunch",    desc: "Declare a 'focus period.'",                                         effects: { scope: 1, morale: -3 },             consequence: "You recovered some time. One engineer updated their LinkedIn during standup." },
        { label: "Push the launch date",       desc: "Announce a revised timeline and prepare the explanation.",           effects: { scope: 2, morale: 1, trust: -1 },   consequence: "More time. Team relieved. CEO is in your calendar tomorrow morning." },
      ],
    },
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { label: "Make documentation a launch blocker", desc: "Announce that nothing ships without docs.",                    effects: { tech: 2, morale: -2, scope: -1 }, consequence: "Nuclear option. The team delivers. They are tired and very vocal about it." },
      ],
    },
    {
      ...
      choices: [
        { label: "Add it",                      desc: "Say yes. It's probably fine.",                                       effects: { scope: 2, trust: 1 },    consequence: "The feature is added. This was not the final request." },
  ...
  4: [ // Testing
    ...
    },
    {
      ...
      choices: [
        { label: "Delay for the week -- get to 80%",      desc: "Spend the week. Ship with confidence.",                     effects: { scope: -1, quality: 2, tech: 1 },  consequence: "Your QA lead is satisfied. Engineering quietly admits it was the right call. Nobody says this out loud." },
        ...
        { label: "Focus coverage only on critical paths", desc: "Cover what matters. Ignore the rest. Mostly.",              effects: { quality: 1, scope: 1 },            consequence: "Pragmatic. The uncovered areas stay quiet. This time." },
    ...
    },
    {
      ...
      choices: [
        { label: "Delay launch",                          desc: "Call it a 'stability-first decision.'",                      effects: { scope: -1, quality: 1, morale: 1 }, consequence: "Everyone gets some sleep. The root cause turns out to be a one-line fix. Nobody says this was the wrong call." },
        ...
        { label: "Roll back to the previous build",       desc: "Return to the last version that mostly worked.",             effects: { tech: 1, scope: -1, morale: -1 },   consequence: "Safe. The rollback procedure worked perfectly, which is itself meaningful." },
    ...
    },
    {
      ...
      choices: [
        { label: "Delay the demo",               desc: "Buy time. Find the real problem.",                                  effects: { scope: 1, trust: -1 },    consequence: "The demo is rescheduled. The root cause is a setting nobody can account for. Nobody admits touching it." },
...
const PM_STYLES = {
  ...
  scope_good: { emoji: '🔮', title: 'The Visionary',             desc: "You thought about the long game. The scope stayed focused beyond the next sprint. Sometimes far beyond." },
  scope_bad:  { emoji: '🗺️', title: 'The Scope Warrior',         desc: "Deadlines meant something to you. Scope was negotiated. Features were cut. The schedule survived. Mostly." },
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-2.5">
              {[
                { color: 'bg-violet-500',  label: 'Scope', desc: 'Are you still on track to ship?' },
